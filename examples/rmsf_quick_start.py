#!/usr/bin/env python3
"""
AfterMD RMSF Quick Start Example

演示如何从AfterMD包中使用RMSF分析功能。
"""
...
from aftermd.analysis import RMSFAnalyzer
...
def example_phla_tcr_analyzer():
    ...
    code = '''
from aftermd.analysis import pHLATCRAnalyzer
from aftermd.utils import pHLATCRVisualizer
...
def example_cdr3_only():
    ...
    code = '''
import MDAnalysis as mda
from aftermd.analysis import calculate_cdr3_rmsf
...
# 进入AfterMD目录
cd /public/home/xmy/tools/AfrerMD
...
def example_advanced():
    ...
    code = '''
import MDAnalysis as mda
from aftermd.analysis import analyze_phla_tcr_rmsf
from pathlib import Path
import pandas as pd
...
def main():
    ...
    print("测试导入:")
    try:
        from aftermd.analysis import RMSFAnalyzer, pHLATCRAnalyzer
        from aftermd.utils import pHLATCRVisualizer
        print("  ✓ 所有模块导入成功!")
