...
"""
            ...
            # Use AfterMD python interface for intelligent group selection
            command = f"""
...
Examples:
  ...
  python -m aftermd.utils.slurm_rmsd_generator /data/processed_trajectories

  # Custom batch size and partition
  python -m aftermd.utils.slurm_rmsd_generator /data/processed \\
