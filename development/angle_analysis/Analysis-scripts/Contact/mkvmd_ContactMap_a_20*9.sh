  ...
  global NumMap
    ...
    foreach res_i [lsort -unique -integer [\$sel get resid]] {
        ...
        foreach contact_res_id [lsort -unique -integer [\$sel_icontact get resid]] {
          ...
          set sel_icontactj [atomselect top "noh and \$sel_stats and resid \$contact_res_id and sidechain and within 4 of ($SEL3 and resid \$res_i and sidechain)" frame \$nf]
    ...
    puts \$outf [format \$formatStr1 "--" S L F N T I A V L]
    ...
    foreach resitem \$reslist t1 \$list_1 t2 \$list_2 t3 \$list_3 t4 \$list_4 t5 \$list_5 t6 \$list_6 t7 \$list_7 t8 \$list_8 t9 \$list_9 {
      puts \$outf [format \$formatStr2 \$resitem \$t1 \$t2 \$t3 \$t4 \$t5 \$t6 \$t7 \$t8 \$t9]
    } 
}
...
for {set nf 1} {\$nf < \$total_frame} {incr nf} {
